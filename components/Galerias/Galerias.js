...
const Galerias = () => {
  return (
    <section className="galeriasContainer" id="galerias">
      ...
      <Link href={'/galeria/tela'} ><button className="galBtnB">TRABAJOS EN TELA</button></Link>
      <Link href={'/galeria/feria'} ><button className="galBtnC">FERIA PICANTE</button></Link>
    </section>
  )
}
